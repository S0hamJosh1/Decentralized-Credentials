...
export function resendTeamInvitation(invitationId) {
  return request(`/api/team/invitations/${encodeURIComponent(invitationId)}/resend`, {
    method: "POST",
  });
}

export function revokeTeamInvitation(invitationId) {
  return request(`/api/team/invitations/${encodeURIComponent(invitationId)}/revoke`, {
    method: "PATCH",
  });
}
